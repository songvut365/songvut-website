...
export default function ProjectCard(props) {
  ...
  return (
    ...
    flex flex-col justify-between pb-2'>
      ...
      ? <>
        <div>
          <img src={project.cover} className="rounded-t-md w-full h-48 object-cover hover:cursor-pointer" />
      ...
      : <div>
          ...
          <div className='flex flex-col px-2 pt-2'>
            <ul className="animate-pulse py-3 space-y-3">
              ...
              <li className="w-full h-3 bg-zinc-400 rounded-md" style={{width: "100%"}}></li>
              <li className="w-full h-3 bg-zinc-400 rounded-md" style={{width: "100%"}}></li>
              <li className="w-full h-3 bg-zinc-400 rounded-md" style={{width: "80%"}}></li>
            </ul>
          </div>
        </div>
      }
